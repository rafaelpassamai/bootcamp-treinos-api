 ...
 * API gerenciadora de treinos
 * API para gerenciar treinos e exercícios
...
export type getUserTrainDataResponse = getUserTrainDataResponseSuccess;
...
export type upsertUserTrainDataResponse = upsertUserTrainDataResponseSuccess;
